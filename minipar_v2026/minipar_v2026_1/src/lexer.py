...
class TokenType(Enum):
    ...
    TRUE            = 'TRUE'
    FALSE           = 'FALSE'
    NULL_LITERAL    = 'NULL_LITERAL'   # NOVO v2026.1

    # ── Identificador ─────────────────────────────────────────────────────────
    IDENTIFIER      = 'IDENTIFIER'

    # ── Palavras-chave existentes (v2026.1) ───────────────────────────────────
    VAR             = 'VAR'
    FUNC            = 'FUNC'
    IF              = 'IF'
    ELSE            = 'ELSE'
    ...
    # ── Palavras-chave POO (NOVO v2026.1) ─────────────────────────────────────
    CLASS           = 'CLASS'
    NEW             = 'NEW'
    THIS            = 'THIS'
    EXTENDS         = 'EXTENDS'
    ...
    # ── Palavras-chave Paralelismo (NOVO v2026.1) ─────────────────────────────
    ASYNC           = 'ASYNC'
    AWAIT           = 'AWAIT'
    SPAWN           = 'SPAWN'
    SYNC_KW         = 'SYNC_KW'

    # ── Palavras-chave Distribuição (NOVO v2026.1) ────────────────────────────
    REMOTE          = 'REMOTE'
    ON              = 'ON'
    NODE            = 'NODE'
...
class Lexer:
    """
    Analisador léxico MiniPar v2026.1.
    Extensão aditiva: todas as palavras-chave v2026.1 são preservadas.
    """

    # ── Palavras-chave v2026.1 (inalteradas) ──────────────────────────────────
    KEYWORDS_V1 = {
        'var':       TokenType.VAR,
        'func':      TokenType.FUNC,
        'if':        TokenType.IF,
