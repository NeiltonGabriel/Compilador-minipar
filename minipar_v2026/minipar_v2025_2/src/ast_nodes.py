"""
ast_nodes.py — MiniPar v2025.2
Nós da Árvore Sintática Abstrata.
Todos os nós v2025.1 são preservados; novos nós são adicionados ao final.
"""
...
# ─────────────────────────────────────────────────────────────────────────────
# Nós existentes v2025.1 (inalterados)
# ─────────────────────────────────────────────────────────────────────────────
...
@dataclass
class MethodCallOld:
    """Chamada de método v2025.1: obj.metodo(args) como statement separado."""
    obj: str
    metodo: str
    argumentos: List[Any]
    linha: int = 0
...
# ─────────────────────────────────────────────────────────────────────────────
# Novos nós v2025.2 — Paralelismo Avançado
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# Novos nós v2025.2 — Execução Distribuída
# ─────────────────────────────────────────────────────────────────────────────
