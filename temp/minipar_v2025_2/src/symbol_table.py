"""
symbol_table.py — MiniPar v2025.2
...
class SymbolType(Enum):
    ...
    PARAMETER  = 'PARAMETER'
    CHANNEL    = 'CHANNEL'
    CLASS      = 'CLASS'      # NOVO v2025.2
    METHOD     = 'METHOD'     # NOVO v2025.2
    FIELD      = 'FIELD'      # NOVO v2025.2
...
# ─────────────────────────────────────────────────────────────────────────────
# Estruturas de layout de classe (NOVO v2025.2)
# ─────────────────────────────────────────────────────────────────────────────
...
class SymbolTable:
    """
    Tabela de símbolos hierárquica estendida para MiniPar v2025.2.
    Adiciona class_registry e node_registry aos escopos existentes.
    """

    def __init__(self):
        # ── Escopos (existente v2025.1) ───────────────────────────────────────
    ...
    def is_subtype_of(self, tipo_filho: str, tipo_pai: str) -> bool:
        ...
        if tipo_filho == tipo_pai:
            return True
        if tipo_pai == 'any' or tipo_filho == 'any':
            return True
        # Conversão implícita number ↔ string (mantido do v2025.1)
